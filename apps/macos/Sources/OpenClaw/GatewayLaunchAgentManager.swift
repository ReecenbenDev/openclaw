...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.reecenbot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".reecenbot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.reecenbotCommand(
            subcommand: "gateway",
