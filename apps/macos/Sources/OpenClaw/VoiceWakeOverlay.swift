...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.reecenbot", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Reecenbot windows, but below the system’s pop-up menus.
