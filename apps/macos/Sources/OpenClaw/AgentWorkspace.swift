...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.reecenbot", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ReecenbotConfigFile.defaultWorkspaceURL() }
