...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .reecenbotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ReecenbotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ReecenbotPaths.stateDirURL.path
