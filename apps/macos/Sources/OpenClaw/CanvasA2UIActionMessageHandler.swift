...
final class CanvasA2UIActionMessageHandler: NSObject, WKScriptMessageHandler {
    ...
    func userContentController(_: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        let text = ReecenbotCanvasA2UIAction.formatAgentMessage(messageContext)
        ...
        Task { [weak webView] in
            ...
            await MainActor.run {
                ...
                let js = ReecenbotCanvasA2UIAction.jsDispatchA2UIActionStatus(
                    actionId: actionId,
                    ok: result.ok,
                    error: result.error)
    ...
    // Formatting helpers live in ReecenbotKit (`ReecenbotCanvasA2UIAction`).
}
