...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: ReecenbotProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": ReecenbotProtocol.AnyCodable("start"),
                "name": ReecenbotProtocol.AnyCodable("bash"),
            ],
            summary: nil)
