...
public enum ReecenbotCanvasA2UICommand: String, Codable, Sendable {
...
public struct ReecenbotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ReecenbotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
