...
@MainActor
public struct ReecenbotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ReecenbotChatViewModel
    ...
    public init(
        viewModel: ReecenbotChatViewModel,
    ...
    private var visibleMessages: [ReecenbotChatMessage] {
        let base: [ReecenbotChatMessage]
    ...
    private func mergeToolResults(in messages: [ReecenbotChatMessage]) -> [ReecenbotChatMessage] {
        ...
        for message in messages {
            ...
            let merged = ReecenbotChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: ReecenbotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ReecenbotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ReecenbotChatMessage) -> String {
