...
public typealias ReecenbotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ReecenbotPlatformImage = UIImage
#endif

public struct ReecenbotChatUsageCost: Codable, Hashable, Sendable {
...
public struct ReecenbotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ReecenbotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ReecenbotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ReecenbotChatMessageContent: Codable, Hashable, Sendable {
...
public struct ReecenbotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ReecenbotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ReecenbotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ReecenbotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ReecenbotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ReecenbotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ReecenbotChatMessageContent].self, forKey: .content) {
...
public struct ReecenbotChatHistoryPayload: Codable, Sendable {
...
public struct ReecenbotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ReecenbotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ReecenbotSessionPreviewItem]
}

public struct ReecenbotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ReecenbotSessionPreviewEntry]

    public init(ts: Int, previews: [ReecenbotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ReecenbotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ReecenbotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ReecenbotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ReecenbotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ReecenbotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ReecenbotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ReecenbotPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: ReecenbotPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct ReecenbotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
