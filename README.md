# Reecenbot — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/reecenbot/reecenbot/main/docs/assets/reecenbot-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/reecenbot/reecenbot/main/docs/assets/reecenbot-logo-text.png" alt="Reecenbot" width="500">
    </picture>
</p>

<p align="center">
  <a href="https://github.com/reecenbot/reecenbot/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/reecenbot/reecenbot/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/reecenbot/reecenbot/releases"><img src="https://img.shields.io/github/v/release/reecenbot/reecenbot?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Reecenbot** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://reecenbot.ai) · [Docs](https://docs.reecenbot.ai) · [DeepWiki](https://deepwiki.com/reecenbot/reecenbot) · [Getting Started](https://docs.reecenbot.ai/start/getting-started) · [Updating](https://docs.reecenbot.ai/install/updating) · [Showcase](https://docs.reecenbot.ai/start/showcase) · [FAQ](https://docs.reecenbot.ai/start/faq) · [Wizard](https://docs.reecenbot.ai/start/wizard) · [Nix](https://github.com/reecenbot/nix-clawdbot) · [Docker](https://docs.reecenbot.ai/install/docker) · [Discord](https://discord.gg/clawd)
...
New install? Start here: [Getting started](https://docs.reecenbot.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.reecenbot.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.reecenbot.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.reecenbot.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.reecenbot.ai/start/getting-started)
...
# Send a message
openclaw message send --to +1234567890 --message "Hello from Reecenbot"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
openclaw agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.reecenbot.ai/install/updating) (and run `openclaw doctor`). Things broken? [Reset and setup](https://docs.reecenbot.ai/start/reset-and-setup).

## Telegram (remote control)

To use Telegram for remote control and notifications:

1. Create a bot with [@BotFather](https://t.me/BotFather), copy the token.
2. Set `TELEGRAM_BOT_TOKEN=...` in `.env` or add `channels.telegram.botToken` in config.
3. Start the gateway; DM the bot and approve pairing: `openclaw pairing approve telegram <CODE>`.

See [Telegram channel](docs/channels/telegram.md) and [PRD mapping](docs/PRD.md) for the 24/7 digital workforce setup (heartbeat cycles, cron, Notion/Google Drive).
...
Details: [Development channels](https://docs.reecenbot.ai/install/development-channels).
...
Full security guide: [Security](https://docs.reecenbot.ai/gateway/security)
...
- **[Local-first Gateway](https://docs.reecenbot.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.reecenbot.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.reecenbot.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.reecenbot.ai/nodes/voicewake) + [Talk Mode](https://docs.reecenbot.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.reecenbot.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.reecenbot.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.reecenbot.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.reecenbot.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.reecenbot.ai/nodes).
- **[Onboarding](https://docs.reecenbot.ai/start/wizard) + [skills](https://docs.reecenbot.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=reecenbot/reecenbot&type=date&legend=top-left)](https://www.star-history.com/#reecenbot/reecenbot&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.reecenbot.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.reecenbot.ai/web), and [Canvas host](https://docs.reecenbot.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.reecenbot.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.reecenbot.ai/start/wizard), and [doctor](https://docs.reecenbot.ai/gateway/doctor).
- [Pi agent runtime](https://docs.reecenbot.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.reecenbot.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.reecenbot.ai/concepts/groups).
- [Media pipeline](https://docs.reecenbot.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.reecenbot.ai/nodes/audio).

### Channels

- [Channels](https://docs.reecenbot.ai/channels): [WhatsApp](https://docs.reecenbot.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.reecenbot.ai/channels/telegram) (grammY), [Slack](https://docs.reecenbot.ai/channels/slack) (Bolt), [Discord](https://docs.reecenbot.ai/channels/discord) (discord.js), [Google Chat](https://docs.reecenbot.ai/channels/googlechat) (Chat API), [Signal](https://docs.reecenbot.ai/channels/signal) (signal-cli), [iMessage](https://docs.reecenbot.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.reecenbot.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.reecenbot.ai/channels/msteams) (extension), [Matrix](https://docs.reecenbot.ai/channels/matrix) (extension), [Zalo](https://docs.reecenbot.ai/channels/zalo) (extension), [Zalo Personal](https://docs.reecenbot.ai/channels/zalouser) (extension), [WebChat](https://docs.reecenbot.ai/web/webchat).
- [Group routing](https://docs.reecenbot.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.reecenbot.ai/channels).

### Apps + nodes

- [macOS app](https://docs.reecenbot.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.reecenbot.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.reecenbot.ai/nodes/talk) overlay, [WebChat](https://docs.reecenbot.ai/web/webchat), debug tools, [remote gateway](https://docs.reecenbot.ai/gateway/remote) control.
- [iOS node](https://docs.reecenbot.ai/platforms/ios): [Canvas](https://docs.reecenbot.ai/platforms/mac/canvas), [Voice Wake](https://docs.reecenbot.ai/nodes/voicewake), [Talk Mode](https://docs.reecenbot.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.reecenbot.ai/platforms/android): [Canvas](https://docs.reecenbot.ai/platforms/mac/canvas), [Talk Mode](https://docs.reecenbot.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.reecenbot.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.reecenbot.ai/tools/browser): dedicated reecenbot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.reecenbot.ai/platforms/mac/canvas): [A2UI](https://docs.reecenbot.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.reecenbot.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.reecenbot.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.reecenbot.ai/automation/cron-jobs); [webhooks](https://docs.reecenbot.ai/automation/webhook); [Gmail Pub/Sub](https://docs.reecenbot.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.reecenbot.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.reecenbot.ai/concepts/channel-routing), [retry policy](https://docs.reecenbot.ai/concepts/retry), and [streaming/chunking](https://docs.reecenbot.ai/concepts/streaming).
- [Presence](https://docs.reecenbot.ai/concepts/presence), [typing indicators](https://docs.reecenbot.ai/concepts/typing-indicators), and [usage tracking](https://docs.reecenbot.ai/concepts/usage-tracking).
- [Models](https://docs.reecenbot.ai/concepts/models), [model failover](https://docs.reecenbot.ai/concepts/model-failover), and [session pruning](https://docs.reecenbot.ai/concepts/session-pruning).
- [Security](https://docs.reecenbot.ai/gateway/security) and [troubleshooting](https://docs.reecenbot.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.reecenbot.ai/web) + [WebChat](https://docs.reecenbot.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.reecenbot.ai/gateway/tailscale) or [SSH tunnels](https://docs.reecenbot.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.reecenbot.ai/install/nix) for declarative config; [Docker](https://docs.reecenbot.ai/install/docker)-based installs.
- [Doctor](https://docs.reecenbot.ai/gateway/doctor) migrations, [logging](https://docs.reecenbot.ai/logging).
...
- **[Gateway WebSocket network](https://docs.reecenbot.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.reecenbot.ai/gateway)).
- **[Tailscale exposure](https://docs.reecenbot.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.reecenbot.ai/gateway/remote)).
- **[Browser control](https://docs.reecenbot.ai/tools/browser)** — reecenbot‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.reecenbot.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.reecenbot.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.reecenbot.ai/nodes/voicewake) + [Talk Mode](https://docs.reecenbot.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.reecenbot.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.
...
Details: [Tailscale guide](https://docs.reecenbot.ai/gateway/tailscale) · [Web surfaces](https://docs.reecenbot.ai/web)
...
Details: [Remote access](https://docs.reecenbot.ai/gateway/remote) · [Nodes](https://docs.reecenbot.ai/nodes) · [Security](https://docs.reecenbot.ai/gateway/security)
...
Details: [Nodes](https://docs.reecenbot.ai/nodes) · [macOS app](https://docs.reecenbot.ai/platforms/macos) · [Gateway protocol](https://docs.reecenbot.ai/concepts/architecture)
...
Details: [Session tools](https://docs.reecenbot.ai/concepts/session-tool)
...
Runbook: [iOS connect](https://docs.reecenbot.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.reecenbot.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.reecenbot/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.reecenbot/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.reecenbot/reecenbot.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.reecenbot.ai/gateway/configuration)
...
Details: [Security guide](https://docs.reecenbot.ai/gateway/security) · [Docker + sandboxing](https://docs.reecenbot.ai/install/docker) · [Sandbox config](https://docs.reecenbot.ai/gateway/configuration)

### [WhatsApp](https://docs.reecenbot.ai/channels/whatsapp)

- Link the device: `pnpm reecenbot channels login` (stores creds in `~/.reecenbot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.reecenbot.ai/channels/telegram)
...
### [Slack](https://docs.reecenbot.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.reecenbot.ai/channels/discord)
...
### [Signal](https://docs.reecenbot.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.reecenbot.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.reecenbot.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.reecenbot.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.reecenbot.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.reecenbot.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.reecenbot.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.reecenbot.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.reecenbot.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.reecenbot.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.reecenbot.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.reecenbot.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.reecenbot.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.reecenbot.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.reecenbot.ai/platforms/windows), [Linux](https://docs.reecenbot.ai/platforms/linux), [macOS](https://docs.reecenbot.ai/platforms/macos), [iOS](https://docs.reecenbot.ai/platforms/ios), [Android](https://docs.reecenbot.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.reecenbot.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.reecenbot.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.reecenbot.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.reecenbot.ai/gateway/bonjour)
- [Gateway pairing](https://docs.reecenbot.ai/gateway/pairing)
- [Remote gateway README](https://docs.reecenbot.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.reecenbot.ai/web/control-ui)
- [Dashboard](https://docs.reecenbot.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.reecenbot.ai/gateway/health)
- [Gateway lock](https://docs.reecenbot.ai/gateway/gateway-lock)
- [Background process](https://docs.reecenbot.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.reecenbot.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.reecenbot.ai/logging)

## Deep dives

- [Agent loop](https://docs.reecenbot.ai/concepts/agent-loop)
- [Presence](https://docs.reecenbot.ai/concepts/presence)
- [TypeBox schemas](https://docs.reecenbot.ai/concepts/typebox)
- [RPC adapters](https://docs.reecenbot.ai/reference/rpc)
- [Queue](https://docs.reecenbot.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.reecenbot.ai/tools/skills-config)
- [Default AGENTS](https://docs.reecenbot.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.reecenbot.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.reecenbot.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.reecenbot.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.reecenbot.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.reecenbot.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.reecenbot.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.reecenbot.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.reecenbot.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.reecenbot.ai/platforms/mac/voicewake)
- [iOS node](https://docs.reecenbot.ai/platforms/ios)
- [Android node](https://docs.reecenbot.ai/platforms/android)
- [Windows (WSL2)](https://docs.reecenbot.ai/platforms/windows)
- [Linux app](https://docs.reecenbot.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.reecenbot.ai/gmail-pubsub](https://docs.reecenbot.ai/automation/gmail-pubsub)
...
- [reecenbot.ai](https://reecenbot.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@reecenbot](https://x.com/reecenbot)
