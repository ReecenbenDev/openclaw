...
const ensureReecenbotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveReecenbotAgentDir = vi.fn().mockReturnValue("/tmp/reecenbot-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/reecenbot-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureReecenbotModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveReecenbotAgentDir,
}));
