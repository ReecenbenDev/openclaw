...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@reecenbot", { botUsername: "reecenbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@reecenbot args", {
        botUsername: "reecenbot",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@reecenbot: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "reecenbot" })).toBe(
      "/help@otherbot",
    );
  });
