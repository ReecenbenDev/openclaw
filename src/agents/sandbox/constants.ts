...
export const DEFAULT_SANDBOX_IMAGE = "reecenbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "reecenbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "reecenbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "reecenbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "reecenbot-sbx-browser-";
