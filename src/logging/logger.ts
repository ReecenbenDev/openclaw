...
export const DEFAULT_LOG_DIR = "/tmp/reecenbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "reecenbot.log"); // legacy single-file path

const LOG_PREFIX = "reecenbot";
