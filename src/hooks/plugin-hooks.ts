...
import type { ReecenbotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ReecenbotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ReecenbotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
