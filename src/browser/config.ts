...
/**
 * Ensure the default "reecenbot" profile exists in the profiles map.
 ...
 *
 * Note: this is an Reecenbot browser profile (routing config), not a Chrome user profile.
...
function ensureDefaultChromeExtensionProfile(
  ...
  // (legacy single-profile configs may use controlPort+1 for reecenbot/reecenbot CDP).
...
export function resolveProfile(
  ...
  let cdpUrl = "";
  const driver = profile.driver === "extension" ? "extension" : "reecenbot";
