...
const SANDBOX_EXAMPLES = {
  main: [
    ["reecenbot sandbox list", "List all sandbox containers."],
    ["reecenbot sandbox list --browser", "List only browser containers."],
    ["reecenbot sandbox recreate --all", "Recreate all containers."],
    ["reecenbot sandbox recreate --session main", "Recreate a specific session."],
    ["reecenbot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["reecenbot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["reecenbot sandbox list", "List all sandbox containers."],
    ["reecenbot sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ...
    ["reecenbot sandbox recreate --session main", "Recreate a specific session."],
    [
      "reecenbot sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["reecenbot sandbox recreate --browser --all", "Recreate only browser containers."],
    ["reecenbot sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["reecenbot sandbox explain", "Show effective sandbox config."],
    ["reecenbot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["reecenbot sandbox explain --agent work", "Explain an agent sandbox."],
    ["reecenbot sandbox explain --json", "JSON output."],
  ],
} as const;
