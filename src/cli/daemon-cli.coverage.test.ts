...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    process.env.OPENCLAW_STATE_DIR = "/tmp/reecenbot-cli-state";
    process.env.OPENCLAW_CONFIG_PATH = "/tmp/reecenbot-cli-state/openclaw.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        OPENCLAW_STATE_DIR: "/tmp/reecenbot-daemon-state",
        OPENCLAW_CONFIG_PATH: "/tmp/reecenbot-daemon-state/openclaw.json",
