...
${formatHelpExamples([
  ['reecenbot message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'reecenbot message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'reecenbot message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}
