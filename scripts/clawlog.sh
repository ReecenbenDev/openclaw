...
show_usage() {
    cat << EOF
clawlog - Reecenbot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Reecenbot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Reecenbot logs flow through the macOS unified log (subsystem: ai.openclaw).
