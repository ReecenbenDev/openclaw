...
if [[ -z "$version_content" ]]; then
  echo "<h2>Reecenbot $VERSION</h2>"
  echo "<p>Latest Reecenbot update.</p>"
  echo "<p><a href=\"https://github.com/reecenbot/reecenbot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
