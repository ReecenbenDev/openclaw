...
# Output:
# - dist/Reecenbot.app
# - dist/Reecenbot-<version>.zip
# - dist/Reecenbot-<version>.dmg
...
APP="$ROOT_DIR/dist/Reecenbot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Reecenbot-$VERSION.zip"
DMG="$ROOT_DIR/dist/Reecenbot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Reecenbot-$VERSION.notary.zip"
