...
export OPENCLAW_STATE_DIR="/tmp/reecenbot-test"
...
pnpm reecenbot reset --scope config+creds+sessions --yes --non-interactive
...
pnpm reecenbot uninstall --state --yes --non-interactive
