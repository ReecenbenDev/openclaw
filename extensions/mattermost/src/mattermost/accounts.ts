...
export function listMattermostAccountIds(cfg: ReecenbotConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ReecenbotConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ReecenbotConfig): ResolvedMattermostAccount[] {
