import type { ChannelOnboardingAdapter, ReecenbotConfig, WizardPrompter } from "openclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.reecenbot.ai/channels/mattermost",
    ].join("\n"),
