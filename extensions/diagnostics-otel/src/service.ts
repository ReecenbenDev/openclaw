...
import type { DiagnosticEventPayload, ReecenbotPluginService } from "openclaw/plugin-sdk";
...
export function createDiagnosticsOtelService(): ReecenbotPluginService {
  ...
  } satisfies ReecenbotPluginService;
}
