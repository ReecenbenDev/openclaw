...
export function listZalouserAccountIds(cfg: ReecenbotConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ReecenbotConfig): string {
...
function mergeZalouserAccountConfig(cfg: ReecenbotConfig, accountId: string): ZalouserAccountConfig {
