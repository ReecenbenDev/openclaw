...
Reecenbot extension for Zalo Personal Account messaging via [zca-cli](https://zca-cli.dev).
...
```bash
openclaw message send --channel zalouser --target <threadId> --message "Hello from Reecenbot!"
```
