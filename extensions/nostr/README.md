...
Nostr DM channel plugin for Reecenbot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Reecenbot. It enables your bot to:
