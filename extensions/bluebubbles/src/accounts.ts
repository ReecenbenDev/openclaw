...
export function listBlueBubblesAccountIds(cfg: ReecenbotConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ReecenbotConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ReecenbotConfig): ResolvedBlueBubblesAccount[] {
