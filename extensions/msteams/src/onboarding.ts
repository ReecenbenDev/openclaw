...
function setMSTeamsDmPolicy(cfg: ReecenbotConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: ReecenbotConfig, allowFrom: string[]): ReecenbotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
