...
export function listGoogleChatAccountIds(cfg: ReecenbotConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ReecenbotConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ReecenbotConfig): ResolvedGoogleChatAccount[] {
