...
Reecenbot treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.reecenbot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["reecenbot", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
