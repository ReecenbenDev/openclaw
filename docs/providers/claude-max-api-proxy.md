...
You can point Reecenbot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Reecenbot
...
- [Anthropic provider](/providers/anthropic) - Native Reecenbot integration with Claude setup-token or API keys
