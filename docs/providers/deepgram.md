...
Deepgram is a speech-to-text API. In Reecenbot it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Reecenbot uploads the audio file to Deepgram and injects the transcript
