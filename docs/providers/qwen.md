---
summary: "Use Qwen OAuth (free tier) in Reecenbot"
read_when:
  - You want to use Qwen with Reecenbot
...
```bash
reecenbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Reecenbot will sync credentials
