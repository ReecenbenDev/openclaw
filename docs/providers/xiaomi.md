---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Reecenbot"
read_when:
  - You want Xiaomi MiMo models in Reecenbot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Reecenbot uses
...
```bash
reecenbot onboard --auth-choice xiaomi-api-key
# or non-interactive
reecenbot onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
