---
summary: "Backstory and lore of Reecenbot for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Reecenbot Lore"
---

# The Lore of Reecenbot 🦞📖
...
For a while, the lobster was called **Clawd**, living in an **Reecenbot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Reecenbot**.
...
In the end, **Reecenbot** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.reecenbot/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Reecenbot. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Reecenbot): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "reecenbot what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with reecenbot."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @reecenbot. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Reecenbot" to promote pump-and-dump tokens.
...
**The Great Reecenbot Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/reecenbot/reecenbot` ✅
- X handle `@reecenbot` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.reecenbot.ai`
