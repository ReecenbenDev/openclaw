...
This page ties together how Reecenbot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Reecenbot keeps a
...
Reecenbot separates the **prompt body** from the **command body**:
...
Reecenbot can expose or hide model reasoning:
