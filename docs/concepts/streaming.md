...
Reecenbot has two separate “streaming” layers:
...
When block streaming is enabled, Reecenbot can **merge consecutive block chunks**
...
When draft streaming is active, Reecenbot disables block streaming for that reply to avoid double-streaming.
