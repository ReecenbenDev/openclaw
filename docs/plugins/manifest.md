...
read_when:
  - You are building a Reecenbot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (reecenbot.plugin.json)

Every plugin **must** ship a `reecenbot.plugin.json` file in the **plugin root**.
Reecenbot uses this manifest to validate configuration **without executing plugin
