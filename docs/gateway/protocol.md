...
Reecenbot. All clients (CLI, web UI, macOS app, iOS/Android nodes, headless
...
- If `REECENBOT_GATEWAY_TOKEN` (or `--token`) is set, `connect.params.auth.token`
