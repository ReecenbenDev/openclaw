...
Deploy Reecenbot on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/reecenbot` — Control UI
...
- `OPENCLAW_STATE_DIR=/data/.reecenbot` (recommended)
...
This exports your Reecenbot state + workspace so you can migrate to another host without losing config or memory.
