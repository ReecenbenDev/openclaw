...
- Install via CLI: `reecenbot plugins install @reecenbot/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `reecenbot plugins install ./extensions/zalo`
   - From npm (if published): `reecenbot plugins install @reecenbot/zalo`
...
- Approve via:
  - `reecenbot pairing list zalo`
  - `reecenbot pairing approve zalo <CODE>`
...
- Example: `reecenbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `reecenbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `reecenbot logs --follow`
