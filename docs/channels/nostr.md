...
read_when:
  - You want Reecenbot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Reecenbot to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`reecenbot onboard`) and `reecenbot channels add` list optional channel plugins.
...
```bash
reecenbot plugins install @reecenbot/nostr
```

Use a local checkout (dev workflows):

```bash
reecenbot plugins install --link <path-to-reecenbot>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "reecenbot",
        "displayName": "Reecenbot",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "reecenbot@example.com",
        "lud16": "reecenbot@example.com"
      }
    }
  }
}
